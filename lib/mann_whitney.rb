...
"
  ...
  def self.ranking_score(total_true, total_false, passed_true, passed_false)
    ...
    return 0 if (passed_false == total_false)\
              || (passed_true == total_true)\
              || ((passed_false == 0) && total_false > 0)\
              || ((passed_true == 0) && total_true > 0)
