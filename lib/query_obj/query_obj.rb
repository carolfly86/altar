...
class QueryObj
  ...
  def initialize(options)
    ...
    @allCols = DBConn.getAllRelFieldList(parseTree['SELECT']['fromClause'])
  end
  ...
  def create_stats_tbl()
        ...
        resultQuery = %Q(with result as (#{selectQuery} join t_result on #{pkJoinList.join(' AND ')}))
